...
{/* second portion */}
    ...
    <h3 className="lg:text-lg md:text-md text-sm font-medium  cursor-pointer text-white font-league-spartan">News & Events</h3>
     ...
     <h3 className="lg:text-lg md:text-md text-sm font-medium  cursor-pointer text-white font-league-spartan">Gallery</h3>
      ...
      <h3 className="lg:text-lg md:text-md font-medium  cursor-pointer text-white font-league-spartan">Tution(LKG to +2)</h3>
    ...
    <div className="flex items-center">
      <h3 className="lg:text-lg md:text-md text-smfont-medium cursor-pointer text-white ml-2 font-league-spartan ">7736965145 | 8086029291 </h3>
    </div> 
    </div>
